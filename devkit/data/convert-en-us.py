...
with open(input_file_path, "r", encoding="utf-8") as input_file:
    ...
    for line in lines:
        ...
        if line.startswith(("# NPC Monsters")):
        ...
        elif start_flag_monster and not line.startswith(("# NPC Monsters", "# Battle Stages")):
        ...
        if start_flag_avatar and line.startswith(("# Items")):
            ...
            start_flag_head = False
        elif start_flag_monster and line.startswith(("# Battle Stages")):
            start_flag_monster = False
